...
namespace DoctorAppointments.Controllers
{
    public class Appointments1Controller : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "appointmentID,appointmentDate,startAppTime,endAppTime,doctorAMKA,patientAMKA,isAvailable")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
